...
import static com.brillianttigercorp.bioxml.parser.pubmed.parser.ArticleParser.*;
...
public class MedlineCitationParser {
    ...
    // Helper methods
    private static com.brillianttigercorp.bioxml.parser.common.model.PubMedDate convertDateToPubMedDate(Date date) {
        if (date == null) return null;
        return com.brillianttigercorp.bioxml.parser.common.model.PubMedDate.builder()
