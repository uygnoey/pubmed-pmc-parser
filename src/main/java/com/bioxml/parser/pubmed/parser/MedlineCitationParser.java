...
import static com.bioxml.parser.pubmed.parser.ArticleParser.*;
...
public class MedlineCitationParser {
    ...
    // Helper methods
    private static com.bioxml.parser.common.model.PubMedDate convertDateToPubMedDate(Date date) {
        if (date == null) return null;
        return com.bioxml.parser.common.model.PubMedDate.builder()
