 ...
 * Td / 테이블 데이터 셀
 *
 * KR: XHTML 테이블 데이터 셀. JATS 1.4 DTD 완전 준수 모델.
 * EN: XHTML table data cell. Fully compliant with JATS 1.4 DTD.
 *
 * DTD: <!ELEMENT td (#PCDATA | %inside-cell;)*>
 *
 * DTD: <!ATTLIST td
 *          abbr CDATA #IMPLIED
 ...
 *      >
 *
 * Reference: https://jats.nlm.nih.gov/archiving/tag-library/1.4/element/td.html
 *
 * Example:
 * <td colspan="1" rowspan="2" align="right">Data Value</td>
 */
@Data
@Builder
@NoArgsConstructor
...
public class Td {
     ...
     * 범위 / Scope
     *
     * KR: 데이터가 적용되는 범위 (일반적으로 th에서만 사용).
     * EN: Scope of the data (usually used only in th).
     *
