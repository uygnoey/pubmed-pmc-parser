...
public class BoxedText {
     ...
     * 그림 목록 / Figure list
     *
     * KR: 박스 텍스트에 포함된 그림 목록.
     * EN: List of figures in the boxed text.
     *
     * DTD: fig*
     * Required: NO (0 or more)
     */
     ...
     *
     * KR: 박스 텍스트에 포함된 테이블 목록.
     * EN: List of tables in the boxed text.
     *
     * DTD: table-wrap*
     * Required: NO (0 or more)
     */
     ...
     * 목록 / List
     *
     * KR: 박스 텍스트에 포함된 목록 (순서/비순서).
     * EN: Lists (ordered/unordered) in the boxed text.
     *
     * DTD: list*
     * Required: NO (0 or more)
     *
     ...
     *
     * KR: 박스 텍스트에 포함된 정의 목록.
     * EN: List of definition lists in the boxed text.
     *
     * DTD: def-list*
     * Required: NO (0 or more)
     */
     ...
     *
     * KR: 박스 텍스트에 포함된 인용구 목록.
     * EN: List of display quotes in the boxed text.
     *
     * DTD: disp-quote*
     * Required: NO (0 or more)
     */
     ...
     *
     * KR: 박스 텍스트에 포함된 코드 블록 목록.
     * EN: List of code blocks in the boxed text.
     *
     * DTD: code*
     * Required: NO (0 or more)
     */
     ...
     *
     * KR: 박스 텍스트에 포함된 표시 수식 목록.
     * EN: List of display formulas in the boxed text.
     *
     * DTD: disp-formula*
     * Required: NO (0 or more)
     */
