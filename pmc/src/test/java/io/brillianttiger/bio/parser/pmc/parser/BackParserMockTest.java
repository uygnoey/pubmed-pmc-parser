...
import io.brillianttiger.bio.parser.pmc.model.MixedCitation;
import io.brillianttiger.bio.parser.pmc.model.Source;
...
class BackParserMockTest {
    ...
    void testParseRef_WithMockedNullSourceValue() throws Exception {
        ...
        try (MockedStatic<CommonPmcElementParser> mockedStatic = mockStatic(CommonPmcElementParser.class, Mockito.CALLS_REAL_METHODS)) {
            ...
            io.brillianttiger.bio.parser.pmc.model.Ref ref = BackParser.parseRef(reader);
            ...
            io.brillianttiger.bio.parser.pmc.model.MixedCitation citation = ref.getMixedCitations().get(0);
