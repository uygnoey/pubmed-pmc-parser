...
public class BodyParser {
            ...
            if (event == XMLStreamConstants.START_ELEMENT) {
                ...
                switch (localName) {
                    ...
                    case "p":
                        ...
                        break;
                    case "list":
                        // TODO: Add list support to Body model
                        parseList(reader); // Parse but don't store yet
                        break;
                    case "def-list":
                        // TODO: Add defList support to Body model
                        parseDefList(reader); // Parse but don't store yet
                        break;
                    case "disp-quote":
                        // TODO: Add dispQuote support to Body model
                        parseDispQuote(reader); // Parse but don't store yet
                        break;
                    case "boxed-text":
                        // TODO: Add boxedText support to Body model
                        parseBoxedText(reader); // Parse but don't store yet
                        break;
                    case "code":
                        // TODO: Add code support to Body model
                        parseCode(reader); // Parse but don't store yet
                        break;
                    default:
                        skipElement(reader);
                        break;
            ...
            if (event == XMLStreamConstants.START_ELEMENT) {
                ...
                switch (localName) {
                    ...
                    case "sec":
                        ...
                        break;
                    case "list":
                        // TODO: Add list support to Sec model
                        parseList(reader); // Parse but don't store yet
                        break;
                    case "def-list":
                        // TODO: Add defList support to Sec model
                        parseDefList(reader); // Parse but don't store yet
                        break;
                    case "disp-quote":
                        // TODO: Add dispQuote support to Sec model
                        parseDispQuote(reader); // Parse but don't store yet
                        break;
                    case "boxed-text":
                        // TODO: Add boxedText support to Sec model
                        parseBoxedText(reader); // Parse but don't store yet
                        break;
                    case "code":
                        // TODO: Add code support to Sec model
                        parseCode(reader); // Parse but don't store yet
                        break;
                    default:
                        skipElement(reader);
     ...
     * DTD: <!ELEMENT list-item (label?, title?, p*, list*)>
     ...
     * DTD: <!ELEMENT def (label?, title?, p*, def-list*)>
     ...
     * DTD: <!ELEMENT disp-quote (label?, title?, p*, attrib?, permissions?)>
            ...
            if (event == XMLStreamConstants.START_ELEMENT) {
                ...
                switch (localName) {
                    ...
                    case "attrib":
                        ...
                        break;
                    case "permissions":
                        // TODO: Implement parsePermissions when Permissions model is created
                        skipElement(reader);
                        break;
                    default:
                        skipElement(reader);
     ...
     * DTD: <!ELEMENT boxed-text (sec-meta?, label?, caption?, p*, sec*, attrib?, permissions?)>
            ...
            if (event == XMLStreamConstants.START_ELEMENT) {
                ...
                switch (localName) {
                    ...
                    case "label":
                        ...
                        break;
                    case "caption":
                        // TODO: Implement parseCaption when Caption model is created
                        skipElement(reader);
                        break;
                    case "p":
                        paragraphs.add(parseP(reader));
